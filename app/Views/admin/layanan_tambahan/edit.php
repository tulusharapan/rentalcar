<?= view('admin/layouts/header', ['title' => 'Edit Layanan Tambahan - Aplikasi']) ?>
...
<?= view('admin/layouts/topbar', [
    'pageTitle'    => 'Edit Layanan Tambahan',
    'pageSubtitle' => 'Perbarui nama, harga, dan icon layanan.',
...
<section class="content-area">
    ...
    <div class="panel p-4">
        <form action="<?= site_url('admin/layanan-tambahan/update/' . $layanan['id']) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <?php $selectedIcon = old('icon', $layanan['icon']); ?>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <input type="text" class="form-control currency-input" id="harga_layanan" name="harga_layanan" value="<?= old('harga_layanan', $layanan['harga_layanan']) ?>" required>
                </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-dark">Update Layanan</button>
            </div>
        </form>
    </div>
</section>
